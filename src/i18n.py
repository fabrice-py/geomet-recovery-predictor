...
"drx_import_title": {"fr": "Import DRX (mineralogie mesuree)", "en": "XRD import (measured mineralogy)"},
   ...
   "add_phase_title": {"fr": "Ajouter une phase", "en": "Add a phase"},
    ...
    "meb_cols_err": {"fr": "Colonnes introuvables (attendu : Mineral, Liberation).",
                     "en": "Columns not found (expected: Mineral, Liberation)."},
    "meb_ok": {"fr": "MEB charge : {n} mineraux.", "en": "SEM loaded: {n} minerals."},
    "meb_empty_err": {"fr": "Aucune liberation valide.", "en": "No valid liberation."},
    "meb_parse_err": {"fr": "Erreur de lecture : {err}", "en": "Read error: {err}"},
